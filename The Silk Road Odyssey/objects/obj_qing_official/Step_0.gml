...
//run to nearest exit
	...
	scr_follow_target(nearest_door.x, nearest_door.y,2)
...
//follow the player
	...
	scr_follow_target(obj_player.x, obj_player.y, 2)
	scr_two_direction_sprite(spr_qing_official_walk)
...
//chase the player
	...
	scr_follow_target(obj_player.x, obj_player.y,3)
...
//hurt
 if (current_state == land_npc_states.hurt) {
    speed = 0;
    image_speed = 1;
